...
var sparkBar3 = function(){
	if(jQuery('#spark-bar-2-2').length > 0 ){	
		$("#spark-bar-2-2").sparkline([33, 22, 68, 54, 8, 30, 74, 7, 36, 5, 41, 19, 43, 29, 38], {
			type: "bar",
			height: "140",
			width: 100,
			barWidth: 10,
...
var sparkBar4 = function(){
	if(jQuery('#spark-bar-2-3').length > 0 ){	
		$("#spark-bar-2-3").sparkline([33, 22, 68, 54, 8, 30, 74, 7, 36, 5, 41, 19, 43, 29, 38], {
			type: "bar",
			height: "140",
			width: 100,
			barWidth: 10,
