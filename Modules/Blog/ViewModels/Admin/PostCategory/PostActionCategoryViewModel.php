...
class PostActionCategoryViewModel extends BaseViewModel
{
    ...
    {
        $this->modelData = new PostCategory();
        $data = [
            'view_model' => $this,
        ];
    ...
    public function edit($request)
    {
        ...
        $this->modelData = PostCategory::find( $request->model_id );
        $data = [
            'view_model' => $this,
        ];
        return $this->renderView('blog::postCategory.form' ,$data);
    ...
    public function destroy($request)
    {
        try {
            ...
            $model = PostCategory::find( $request->model_id );
    ...
    public function saveService( $validData ,  $request)
    {
        try {
            DB::beginTransaction();
            $model = PostCategory::find( $request->model_id ) ?? new PostCategory();
