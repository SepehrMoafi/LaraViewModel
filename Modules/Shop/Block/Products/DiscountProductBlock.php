...
class DiscountProductBlock implements BlockInterface
{
    public $routeBlockConfig =[];
    public $title = 'پیشنهاد و تخفیف';
    ...
    public function renderAdmin()
    {
        ...
        $this->routeBlockConfig = $item_obj->configJson;
        $block = $this;
        return view('shop::theme_admin.blocks.product.discount_product_block_form' , compact('block' ,'item_obj' ,'block_obj'));
    }
