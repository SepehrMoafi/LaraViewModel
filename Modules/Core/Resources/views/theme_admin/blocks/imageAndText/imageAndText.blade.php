                ...
                <div class="intro-y box p-5">
                    ...
                    <div class="sm:grid grid-cols-2 gap-2" style="margin-top: 10px">
                        <div class="mt-5 ">
                            ...
                            <div class="mt-5 ">
                                <label for="crud-form-1" class="form-label">متن</label>
                                <input name="config[description]"  id="crud-form-3" type="text"
                                       value="{{ old( 'description' ,@ $block->routeBlockConfig->description) }}"
