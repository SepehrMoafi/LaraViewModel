...
<head>
    ...
    <title>ادمین</title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('assets/theme_admin/images/favicon.png')}}">
    <link href="{{asset('assets/theme_admin/vendor/jqvmap/css/jqvmap.min.css')}}" rel="stylesheet">
    <link href="{{asset('assets/theme_admin/vendor/chartist/css/chartist.min.css')}}" rel="stylesheet" >
    <link href="{{asset('assets/theme_admin/vendor/datatables/css/jquery.dataTables.min.css')}}" rel="stylesheet">
    <link href="{{asset('assets/theme_admin/vendor/bootstrap-select/dist/css/bootstrap-select.min.css')}}" rel="stylesheet">
    <link href="{{asset('assets/theme_admin/css/style.css')}}" rel="stylesheet">
    ...
    ***********************************-->
    <div class="nav-header">
        <a href="{{url('/admin')}}" class="brand-logo">
            <img class="logo-abbr" src="{{asset('assets/theme_admin/images/logo.png')}}" alt="">
            <span style="
				color: black;
				margin-right: 10px;
				font-weight: bold;
                                        ...
                                        <li>
                                            <div class="timeline-panel">
                                                <div class="media ml-2">
                                                    <img alt="image" width="50" src="{{asset('assets/theme_admin/images/avatar/1.jpg')}}">
                                                </div>
                        ...
                        <li class="nav-item dropdown header-profile">
                            <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                <div class="header-info">
                                    <span class="text-black">سلام,<strong>علی</strong></span>
                                    <p class="fs-12 mb-0">ادمین</p>
                                </div>
                                <img src="{{asset('assets/theme_admin/images/profile/profile.png')}}" width="20" alt="" />
                            </a>
                            <div class="dropdown-menu dropdown-menu-right">
