...
namespace Modules\Core\Block\IconText;
...
class IconTextBlock implements BlockInterface
{
    public $routeBlockConfig = [];

    public $title = 'ایکون و متن';
    ...
    public function renderFront()
    {
        ...
        return view('core::theme_master.blocks.IconAndText.' . $template, compact('block', 'item_obj', 'block_obj'));
