...
namespace Modules\Core\Block\Form;
...
class Form implements BlockInterface
{
    ...
    public function renderFront()
    {
        ...
        return view('core::theme_master.blocks.form.' . $template, compact('block', 'item_obj', 'block_obj'));
    ...
    public function renderAdmin()
    {
        ...
        $this->routeBlockConfig = $item_obj->configJson;
        $block = $this;
        return view('core::theme_admin.blocks.form.form', compact('block', 'item_obj'));
    }
