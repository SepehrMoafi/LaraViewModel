...
class Map implements BlockInterface
{
    ...
    public function renderFront()
    {
        ...
        return view('core::theme_master.blocks.map.' . $template, compact('block', 'item_obj', 'block_obj'));
    ...
    public function renderAdmin()
    {
        ...
        $this->routeBlockConfig = $item_obj->configJson;
        $block = $this;
        return view('core::theme_admin.blocks.map.map', compact('block', 'item_obj'));
    }
