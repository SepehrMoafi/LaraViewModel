...
namespace Modules\Core\Block\SingleImage;

use Modules\Core\Block\BlockInterface;
use Modules\Core\Entities\RouteBlockItem;

class SingleImage implements BlockInterface
{
    ...
    public function renderFront()
    {
        ...
        return view('core::theme_master.blocks.singleImage.singleImage' , compact('block', 'item_obj', 'block_obj'));
    ...
    public function renderAdmin()
    {
        ...
        $this->routeBlockConfig = $item_obj->configJson;
        $block = $this;
        return view('core::theme_admin.blocks.singleImage.singleImage', compact('block', 'item_obj'));
    }
