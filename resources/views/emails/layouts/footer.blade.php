...
<footer class="footer">
    <section class="container-xxl my-4">
        <section class="row my-5">
            <section class="col">
                <section class="fw-bold">شرکت {{ env('APP_NAME') }}</section>
        ...
        <section class="row border-top pt-4">
            <section class="col">
                <section class="text-muted footer-intro text-center">کلیه حقوق این وبسایت متعلق به شرکت {{ env('APP_NAME') }} می باشد.</section>
            </section>
        </section>
    </section>
</footer>
